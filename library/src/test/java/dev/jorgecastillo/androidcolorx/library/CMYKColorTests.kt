...
class CMYKColorTests {
    ...
    fun `lighten integer should enlighten the color`() {
        ...
        assertEquals(CMYKColor(0f, 0.49f, 0.33f, 0.05f), color.lighten(20))
    }
    ...
    fun `lighten float should enlighten the color`() {
        ...
        assertEquals(CMYKColor(0f, 0.49f, 0.33f, 0.05f), color.lighten(0.2f))
    }
    ...
    fun `darken integer should darken the color`() {
        ...
        assertEquals(CMYKColor(0f, 0.90f, 0.60f, 0.43f), color.darken(20))
    }
    ...
    fun `darken float should darken the color`() {
        ...
        assertEquals(CMYKColor(0f, 0.90f, 0.60f, 0.43f), color.darken(0.2f))
    }
    ...
    fun `complimentary colors should be calculated as expected`() {
        ...
        assertEquals(CMYKColor(0.87f, 0.00f, 0.29f, 0.09f), color.complimentary())
    }
